...
filterChipd(List argsList, Map<Symbol, dynamic> origArgsMap) {
  ...
  //* required:
  assert(() {
    if (argsMap[#label] == null || argsMap[#onSelected] == null) {
      throw FlutterError(
          "ChoiceChipd requires `label:Widget` and `onSelected:void Function(bool)`");
    }
    return true;
  }());

  return Function.apply(FilterChip.new, [], argsMap);
}
