...
sliderAdaptived(List argsList, Map<Symbol, dynamic> origArgsMap) {
  ...
  assert(() {
    if (argsMap[#value] == null || argsMap[#onChanged] == null) {
      throw FlutterError("SliderAdaptived requires `value:double` and `onChanged:void Function(double)`");
    }
    return true;
  }());

  return Function.apply(Slider.adaptive, [], argsMap);
}
