...
alertDialogAdaptived(List argsList, Map<Symbol, dynamic> origArgsMap) {
  ...
  for (final arg in argsList) {
    switch (arg) {
      ...
      case ScrollController arg:
        switch (scrollcontrolleri++) {
          case 0:
            argsMap[#scrollController] = arg;
          case 1:
            argsMap[#actionScrollController] = arg;
        }
      case Duration arg:
        argsMap[#insetAnimationDuration] = arg;
      case Curve arg:
        argsMap[#insetAnimationCurve] = arg;
    }
  }
  ...
  return Function.apply(AlertDialog.adaptive, [], argsMap);
}
